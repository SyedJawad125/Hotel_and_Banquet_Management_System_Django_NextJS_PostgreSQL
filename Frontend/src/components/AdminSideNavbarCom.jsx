...
//     setActiveScreen(key);
//     setMobileOpen(false); // close the drawer on mobile after picking a page
//     router.push(path);
//   };
...
//   return (
//     <>
//       {/* Mobile hamburger trigger - only visible below md breakpoint */}
//       <button
//         type="button"
...
//         className={`flex flex-col h-full bg-black overflow-y-auto fixed inset-y-0 left-0 z-50 w-72 transform transition-transform duration-300 ease-in-out md:static md:z-auto md:w-full md:translate-x-0 ${
...
//           className="md:hidden absolute top-4 right-4 z-10 flex items-center justify-center"
//           style={{
//             width: 30,
//             height: 30,
//             borderRadius: 8,
...
//   return (
//     <>
//       {/* Mobile Menu Button — floating, only visible on mobile */}
//       {isMobile && (
//         <button
...
//         {/* Bottom User Card + Change Password + Logout */}
//         <div style={{ padding: 16, borderTop: '1px solid rgba(198,164,63,0.25)' }}>
//           <div
//             style={{
//               display: 'flex',
...
//             onMouseEnter={(e) => {
//               e.currentTarget.style.background = 'rgba(198,164,63,0.08)';
//               e.currentTarget.style.color = '#E8CD7A';
//               e.currentTarget.style.borderColor = 'rgba(198,164,63,0.5)';
//             }}
//             onMouseLeave={(e) => {
//               e.currentTarget.style.background = '#000000';
//               e.currentTarget.style.color = '#B8B8B8';
//               e.currentTarget.style.borderColor = 'rgba(198,164,63,0.25)';
//             }}
//           >
//             <span>🔑</span>
...
export default function AdminSideNavbarCom() {
  ...
  return (
    <>
      ...
      {/* Sidebar — takes half the screen width on mobile (min 240px, max 320px) */}
      <div
        ref={scrollContainerRef}
        onScroll={handleScroll}
        className="flex flex-col h-full bg-black overflow-y-auto"
        style={{
          ...
          transition: isMobile ? 'left 0.32s cubic-bezier(0.4, 0, 0.2, 1)' : 'none',
          boxShadow: isMobile ? '8px 0 30px rgba(0,0,0,0.5)' : 'none',
          borderRight: isMobile ? '1px solid rgba(198,164,63,0.3)' : 'none',
        }}
      >
        {/* Logo */}
        <div className="px-6 py-8 border-b border-yellow-600/25 text-center bg-black">
