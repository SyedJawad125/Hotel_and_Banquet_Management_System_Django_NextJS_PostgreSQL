...
from .views import (
    CustomerView, HallView, RoomView, BookingView, RoomBookingView, ActivityLogView,
    DashboardStatsView, RevenueReportView, RoomRevenueReportView, CustomerReportView,
    PaymentView, HallPricingView, RoomPricingView, BookingServiceView,
    HallAmenityView, RoomAmenityView,
)
...
urlpatterns = [
    ...
    path('v1/hall/', HallView.as_view(), name='hall'),
    path('v1/room/', RoomView.as_view(), name='room'),
    ...
    path('v1/dashboard-stats/', DashboardStatsView.as_view(), name='dashboard-stats'),
    path('v1/reports/revenue/', RevenueReportView.as_view(), name='revenue-report'),
    path('v1/reports/room-revenue/', RoomRevenueReportView.as_view(), name='room-revenue-report'),
    path('v1/reports/customer/', CustomerReportView.as_view(), name='customer-report'),

    path('v1/payment/', PaymentView.as_view(), name='payment'),

    path('v1/hall/pricing/', HallPricingView.as_view(), name='hall-pricing'),
    path('v1/room/pricing/', RoomPricingView.as_view(), name='room-pricing'),

    path('v1/booking/service/', BookingServiceView.as_view(), name='booking-service'),

    path('v1/hall/amenity/', HallAmenityView.as_view(), name='hall-amenity'),
    path('v1/room/amenity/', RoomAmenityView.as_view(), name='room-amenity'),
]